...
namespace StormThrift
{
  ...
  public partial class KeyNotFoundException : TException, TBase
  {
    ...
    public KeyNotFoundException(string msg) : this()
    {
      this.Msg = msg;
    }
    ...
    {
      var tmp125 = new KeyNotFoundException();
      if((Msg != null))
      {
        tmp125.Msg = this.Msg;
      }
    ...
    {
      if (!(that is KeyNotFoundException other)) return false;
    ...
    {
      var tmp128 = new StringBuilder("KeyNotFoundException(");
      if((Msg != null))
      {
        tmp128.Append(", Msg: ");
        Msg.ToString(tmp128);
