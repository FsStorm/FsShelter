...
namespace StormThrift
{
  ...
  public partial class AuthorizationException : TException, TBase
  {
    ...
    {
      var tmp115 = new AuthorizationException();
      if((Msg != null))
      {
        tmp115.Msg = this.Msg;
      }
    ...
    {
      if (!(that is AuthorizationException other)) return false;
    ...
    {
      var tmp118 = new StringBuilder("AuthorizationException(");
      if((Msg != null))
      {
        tmp118.Append(", Msg: ");
        Msg.ToString(tmp118);
