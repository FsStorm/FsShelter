...
namespace StormThrift
{
  ...
  public partial class DRPCExecutionException : TException, TBase
  {
    ...
    {
      var tmp720 = new DRPCExecutionException();
      if((Msg != null))
      {
        tmp720.Msg = this.Msg;
      }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp721 = new TStruct("DRPCExecutionException");
    ...
    {
      if (!(that is DRPCExecutionException other)) return false;
    ...
    {
      var tmp723 = new StringBuilder("DRPCExecutionException(");
      if((Msg != null))
      {
        tmp723.Append(", Msg: ");
        Msg.ToString(tmp723);
