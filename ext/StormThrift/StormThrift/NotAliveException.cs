...
namespace StormThrift
{
  ...
  public partial class NotAliveException : TException, TBase
  {
    ...
    {
      var tmp110 = new NotAliveException();
      if((Msg != null))
      {
        tmp110.Msg = this.Msg;
      }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp111 = new TStruct("NotAliveException");
    ...
    {
      if (!(that is NotAliveException other)) return false;
    ...
    {
      var tmp113 = new StringBuilder("NotAliveException(");
      if((Msg != null))
      {
        tmp113.Append(", Msg: ");
        Msg.ToString(tmp113);
